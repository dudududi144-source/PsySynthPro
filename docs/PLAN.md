...
- v2.7: **Monophonic legato GLIDE** — signature psy-bass portamento. GLIDE knob (0-500ms);
  playing a note while one voice sounds glides its pitch (legato, no retrigger)
